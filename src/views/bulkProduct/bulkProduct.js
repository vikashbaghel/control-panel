...
const BulkProduct = () => {
  ...
  useEffect(() => {
    dispatch(bulkUploadingService("PRODUCTS", ""));
  }, []);
  ...
  useEffect(() => {
    dispatch(bulkUploadingService("PRODUCTS", pageCount));
    setLoading(false);
  }, [pageCount]);

  return (
    <div>
      <h2 className="page_title">Bulk Uploading Product List</h2>
      <Content
        style={{
          padding: 24,
          margin: 0,
