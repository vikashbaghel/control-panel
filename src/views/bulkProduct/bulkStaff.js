...
const BulkStaff = () => {
  ...
  useEffect(() => {
    dispatch(bulkUploadingService("STAFF"));
  }, []);
  ...
  useEffect(() => {
    dispatch(bulkUploadingService("STAFF", pageCount));
    setLoading(false);
  }, [pageCount]);
    ...
    <div>
      <h2 className="page_title">
        ...
        <div className="breadcrumb">
          ...
          <span onClick={() => navigate("/web/bulk-uploading-staff")}>
            {" "}
            / Bulk-Uploading-Staff
          </span>
        </div>
      </h2>
      <Content
